...
@section('content')
<div class="max-w-3xl mx-auto space-y-6" x-data="programForm()">

    {{-- Info banner --}}
    <div class="bg-blue-50 border border-blue-200/60 rounded-xl p-4 flex items-start gap-3 animate-fade-in-up">
        ...
        <div>
            <p class="text-sm font-semibold text-blue-800">Programa de Posgrado</p>
            <p class="text-xs text-blue-600 mt-0.5">Define un programa académico de posgrado con su grado, duración, créditos y coordinador. Los cursos se vincularán a este programa.</p>
        </div>
    </div>
        ...
        <div class="card animate-fade-in-up delay-1">
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="Ej: Maestría en Didáctica de la Educación Superior"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code') }}" required placeholder="Ej: MDES" maxlength="20"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" placeholder="Breve descripción del programa, objetivos y perfil del egresado..."
            ...
            <div class="px-6 py-5 space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="total_credits" value="{{ old('total_credits') }}" min="1" max="500" placeholder="Ej: 72"
                               class="form-input w-full">
                        @error('total_credits') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="form-label">Resolución</label>
                        <input type="text" name="resolution" value="{{ old('resolution') }}" placeholder="N.° de resolución"
                               class="form-input w-full">
...
function programForm() {
    return {
        degreeType: '{{ old('degree_type', 'maestria') }}',
        status: '{{ old('status', 'active') }}',
        durationSemesters: '{{ old('duration_semesters', 6) }}',
        hasPropedeutic: {{ old('has_propedeutic') ? 'true' : 'false' }},
        degreeTypes: [
