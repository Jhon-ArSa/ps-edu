...
@section('content')
<div class="max-w-3xl mx-auto" x-data="{ role: '{{ old('role', 'alumno') }}', showPassword: false, showPasswordConfirm: false }">

    {{-- Header --}}
    <div class="mb-6 animate-fade-in-up">
        <h1 class="text-2xl font-bold text-gray-900">Crear nuevo usuario</h1>
        <p class="text-sm text-gray-500 mt-1">Completa la información para registrar un usuario en el sistema.</p>
    </div>
            ...
            <div class="card-header">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Selecciona el rol que tendrá en el sistema</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="dni" name="dni" value="{{ old('dni') }}" maxlength="20"
            ...
            <div class="card-header">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Contraseña para ingresar al sistema</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="years_of_service" name="years_of_service" value="{{ old('years_of_service') }}"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="bio" name="bio" rows="3"
                                      ...
                                      placeholder="Descripción profesional del docente...">{{ old('bio') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div x-show="role === 'alumno'" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                        <div>
                            <label for="code" class="form-label">Código de matrícula <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        ...
                        <div>
                            ...
                            <input type="number" id="promotion_year" name="promotion_year"
                                   value="{{ old('promotion_year', date('Y')) }}"
                                   min="2000" max="2099"
                                   class="form-input">
                        </div>
        ...
        <div x-show="role === 'admin'" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex items-start gap-3 p-4 rounded-xl bg-red-50 border border-red-200/60">
                ...
                <div>
                    ...
                    <p class="text-xs text-red-600 mt-0.5">Este usuario tendrá acceso completo al sistema: gestión de usuarios, cursos, matrículas, configuración y todos los módulos administrativos.</p>
                </div>
            </div>
        </div>
